...
class VPODE(nn.Module):
    ...
    def forward(self, t_k, states):
        ...
        with torch.set_grad_enabled(True):
            ...
            weight =  self.args.reg_logits if self.args.reg_logits > 1 else 1
            cond_energy_neg = weight * self.ccf.get_cond_energy(z, self.y)  # get_cond_energy
